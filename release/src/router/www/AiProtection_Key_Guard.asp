			...
			<!--=====Beginning of Main Content=====-->
								...
								<table width="100%" border="1" cellspacing="0" cellpadding="4" align="center" class="FormTable_table" id="ruleTable_table">
									...
									<tr id="kg_wan_enable_field" Click="document.form.kg_wan_enable_tmp.checked">
										...
										<td colspan="2">
											<div align="left" style="margin-left:10px">All key devices leave: Disable router internet connection<br>All key devices connectd:Enable router internet connection</div>
										</td>
									</tr>
									<tr id="kg_powersaving_enable_field">
										...
										<td colspan="2">
											<div align="left" style="margin-left:10px">All key devices leave: Enable power saving mode<br>All key devices connectd: Router is in max performance</div>
										</td>
									</tr>
									<tr id="kg_wl_radio_enable_field">
										<td title="kg_wl_radio_enable_title">
											<input class="ruleclass" type="checkbox" name="kg_wl_radio_enable_tmp" id="kg_wl_radio_enable_tmp" value="<% nvram_get("kg_wl_radio_enable"); %>" onClick="document.form.kg_wl_radio_enable_tmp.value=(this.checked==true)?1:0;"></input>
										</td>
										<td>
											<div align="left" style="margin-left:10px">All key devices leave: Disable Wireless Radio<br>All key devices connectd:Enable Wireless Radio</div>
										</td>
										<td width="30%"><div align="left" style="margin-left:10px">
									...
									<tr id="kg_wl1_radio_field" style="display:none">
										...
										<td><div align="left" style="margin-left:10px">All key devices leave: Disable 5GHz Radio<br>All key devices connectd:Enable 5GHz Radio</div></td>
									</tr>
