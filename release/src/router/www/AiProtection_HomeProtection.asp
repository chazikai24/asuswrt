...
smtpList = [
	...
	{smtpServer: "smtp-mail.outlook.com", smtpPort: "587", smtpDomain: "outlook.com"},
	{smtpServer: "smtp.aol.com", smtpPort: "587", smtpDomain: "aol.com"},
	{smtpServer: "smtp.mail.yahoo.com", smtpPort: "465", smtpDomain: "yahoo.com"},
...
function apply_alert_preference(){
	...
	if(address_temp.indexOf('@') != -1){	
		if(account_temp[1] != "gmail.com" && account_temp[1] != "outlook.com" && account_temp[1] != "aol.com" && account_temp[1].indexOf("yahoo.com") == -1 && account_temp[1] != "qq.com" && account_temp[1] != "163.com"){
